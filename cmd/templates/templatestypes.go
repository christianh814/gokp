...
// FluxCD Specifc Vars
var FluxInstallFile string = `apiVersion: v1
kind: Namespace
metadata:
  labels:
...
/*
var FluxKustomizeFile string = `apiVersion: kustomize.config.k8s.io/v1beta1
kind: Kustomization
resources:
- https://github.com/fluxcd/flux2/releases/download/{{.FluxcdVersion}}/install.yaml
- cluster-sshsecret.yaml
...
metadata:
  ...
  namespace: flux-system
data:
  identity: {{.ClusterGitPrivateKey}}
  identity.pub: {{.ClusterGitPublicKey}}
...
var FluxGotkGitRepoFile string = `apiVersion: source.toolkit.fluxcd.io/v1beta1
kind: GitRepository
metadata:
  name: flux-system
  namespace: flux-system
...
var FluxGotkKustomizationFile string = `apiVersion: kustomize.toolkit.fluxcd.io/v1beta2
kind: Kustomization
metadata:
  name: flux-system
  namespace: flux-system
...
var FluxGotkTenantsFile string = `apiVersion: kustomize.toolkit.fluxcd.io/v1beta2
kind: Kustomization
metadata:
  name: tenants
  namespace: flux-system
...
var KuardSampleAppSvc string = `apiVersion: v1
kind: Service
metadata:
  labels:
    app: kuard
